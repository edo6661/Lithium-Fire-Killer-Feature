...
export const ContactCtaSection = () => {
  return (
    <section
      className="relative overflow-hidden bg-background py-20 border-y border-white/5 sm:py-24 text-white"
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8 z-10">
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          >
            {/* Hubungi Kami — outlined pill premium */}
            <ButtonLink
              to={cta.button.href}
            ...
            {/* WhatsApp Sekarang — solid green, premium feel */}
            <motion.a
