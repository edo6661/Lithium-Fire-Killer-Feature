          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-black tracking-tight text-slate-900">{t("product.whyArt.title")}</h3>
              </div>
              <p className="text-lg font-medium text-slate-600 leading-relaxed mb-8">
                {t("product.whyArt.content")}
              </p>
              <p className="text-xs font-black tracking-[0.3em] text-slate-900 opacity-40">{t("product.whyArt.label")}</p>
            </div>
