/**
 * Halaman Tentang Kami — sumber: docs/CONTENT.md § PAGE 2: TENTANG KAMI
 */
...
export const ABOUT_CONTENT = {
  intro: {
    ...
    coreValues: {
      title: "Company's Core Values",
      acronym: "NOFIRE",
      items: [
        { letter: "N", label: "Nationality" },
        { letter: "O", label: "Ownership" },
        { letter: "F", label: "Focus" },
  ...
  location: {
    heading: "Lokasi Kami",
    address:
      "TCC Tower One Menara Batavia — Jl. K.H. Mas Mansyur No. Kav. 126, RT.9/RW.3, Karet Tengsin, Kecamatan Tanah Abang, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10220",
    hours: "Senin – Jumat | Jam 09.00 – 17.00 WIB",
    mapsQuery:
      "TCC+Tower+One+Menara+Batavia+Jl.+K.H.+Mas+Mansyur+Karet+Tengsin+Jakarta+Pusat",
  },
} as const;
